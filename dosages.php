...
<main role="main" class="container">
  ...
  <br>
            <form action="dosagesdb.php" method="POST" class="form-group">
  

               <div class="form-group">
                <label for="sel1">Medicine Name:</label>
                <select class="form-control" id="sel1" name="Medicine">
                  <option>Paracetamol</option>
                  <option>Aspirin</option>
                  <option>Crafenicol</option>
                  
                </select>
              </div>

              <div class="form-group">
                <label for="dat1">date:</label>
                <select class="form-control" id="dat1"  name="Dates">
                  <option>2021-06-01</option>
                  <option>2021-06-02</option>
                  <option>2021-06-03</option>
                  <option>2021-06-04</option>

                </select>
              </div>
             
              <div class="form-group">
                  <label for="tim1">Time Taken:</label>
                  <input type="time" class="form-control" id="tim1" name="MedTimes">
              </div>
